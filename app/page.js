  ...
  return (
    ...
    <ToastContainer theme='dark'/>
      <form onSubmit={onSubmitHandler} className='flex items-start flex-col gap-2 w-[80%] max-w-[600px] mt-24 px-2 mx-auto'>
        <input type='text' value={formData.title} onChange={onChangeHandler} name='title' className='px-3 py-2 border-2 w-full' placeholder='Enter Title' />
        ...
        <button type='submit'  className='bg-orange-600 py-3 mt-1 px-11 text-white'>Add Todo</button> 
      </form>
